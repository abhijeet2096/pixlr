        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header ">
            <header class="mdl-layout__header elegant-color">
                <div class="mdl-layout__header-row">
                    ...
                    <nav class="mdl-navigation mdl-layout--large-screen-only">
                        ...
                        <?php
                        $sql = "SELECT * FROM member WHERE mem_id = '$id_loggedin'";
            ...
            <main>
                ...
                <div class="container">
                    ...
                    $sql1 = "SELECT * FROM r_category where gallery_id = '$gallery_id' ";
...
//$row1 = mysqli_fetch_array($result1);
                    ...
                    while ($row1 = mysqli_fetch_array($result1)) {
                        $img_id_temp_12 = $row1['img_id'];
                        $sql = "SELECT * FROM image where img_id='$img_id_temp_12'";
                        ...
                        if ($following_id != $follower_id) {
                         ...
                         $redirect_gallery="2".$gallery_id;

                            if ($row2) {
                                echo'                             <a href="q3.php?following_id=' . $following_id . '&redirect='.$redirect_gallery.'">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        echo'
                                ...
                                <form action = "q3.php?image_id_test=' . $img_id . '&redirect='.$redirect_gallery.'&person_id=' . $id . '" method = "POST" >
                        ...
                        if ($res) {
                            while ($row = mysqli_fetch_array($res)) {
                                ...
                                echo'<form action = "q3.php?comment_id=' . $comment_id_close . '&redirect='.$redirect_gallery.'" method = "POST">';
